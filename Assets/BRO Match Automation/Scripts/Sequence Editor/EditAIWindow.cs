...
{
    public class EditAIWindow : MonoBehaviour
    {
        ...
        /// <summary>
        /// Starts the process of adding or modifying AI to the match by informing the lobby
        /// </summary>
        public void AddAI()
        {
            m_matchSettingsUI.AddAI(m_availableAIs[m_aiDropdown.value].Instance, m_availableAIs[m_aiDropdown.value].AvatarSprite);
        }
        #endregion
